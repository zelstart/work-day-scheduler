...
$(function () {
  // displays the day of the week and date on the header
  ...
  function loadSave() {
    // getItem from each stored hour key (if there is any value there) and set the text of the corresponding hour to the saved value
